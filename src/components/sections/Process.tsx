            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {processSteps.map((step, idx) => (
                        ...
                        >
                            <div className="mb-6 p-3 rounded-xl bg-neutral-800/50 group-hover:bg-neutral-800 transition-colors border border-white/5 group-hover:scale-110 duration-300">
                                {step.icon}
                            </div>
