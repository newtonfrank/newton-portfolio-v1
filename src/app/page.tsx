...
function App() {
    ...
    return (
        <div className={`min-h-screen transition-colors duration-300 ${isDark ? 'bg-neutral-950 text-white' : 'bg-neutral-50 text-neutral-950'
                ...
                {mobileMenuOpen && (
                    ...
                    >
                        <div className="px-6 py-4 space-y-4">
                            <a href="#about" className={`block transition-colors ${isDark ? 'text-neutral-400 hover:text-white' : 'text-neutral-600 hover:text-neutral-950'
                                }`} onClick={() => setMobileMenuOpen(false)}>
                                About
                            </a>
                            <a href="#projects" className={`block transition-colors ${isDark ? 'text-neutral-400 hover:text-white' : 'text-neutral-600 hover:text-neutral-950'
                                }`} onClick={() => setMobileMenuOpen(false)}>
                                Projects
                            </a>
                            <a href="#skills" className={`block transition-colors ${isDark ? 'text-neutral-400 hover:text-white' : 'text-neutral-600 hover:text-neutral-950'
                                }`} onClick={() => setMobileMenuOpen(false)}>
                                Skills
                            </a>
            ...
            {/* About Section */}
            <section id="about" className={`py-20 px-6 lg:px-8 transition-colors ${isDark ? 'bg-neutral-900/50' : 'bg-neutral-100/50'
                }`}>
                <div className="max-w-7xl mx-auto">
                    <motion.div
                        initial="hidden"
            ...
            <section id="projects" className="py-20 px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className={`max-w-2xl ${isDark ? 'text-neutral-400' : 'text-neutral-600'
                            }`}>
            ...
            {/* Skills Section */}
            <section id="skills" className={`py-20 px-6 lg:px-8 transition-colors ${isDark ? 'bg-neutral-900/50' : 'bg-neutral-100/50'
                }`}>
                <div className="max-w-7xl mx-auto">
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
            ...
            <section id="contact" className="py-20 px-6 lg:px-8">
                ...
                >
                    ...
                    <p className={`text-xl mb-8 leading-relaxed ${isDark ? 'text-neutral-400' : 'text-neutral-600'
                        }`}>
            ...
            {/* Footer */}
            <footer className={`py-8 px-6 lg:px-8 border-t transition-colors ${isDark ? 'border-neutral-800' : 'border-neutral-200'
                }`}>
